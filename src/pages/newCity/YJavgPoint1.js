    ...
    <div>
      <ul className="list">
        <li className="item">
          ...
          <span className="data">
            {SYnumberFormat(SYdata[1].chungyak_won_avg)}
            만원
          </span>
        </li>
        <li className="item">
          <span className="title">다자녀 청약가점</span>
          <span className="data">{SYdata[1].child_point_avg}점</span>
        </li>
        <li className="item">
          <span className="title">신혼부부 청약가점</span>
          <span className="data">{SYdata[1].newlyweds_point_avg}점</span>
        </li>
        <li className="item">
          <span className="title">노부모 청약저축불입액</span>
          <span className="data">
            {SYnumberFormat(SYdata[1].old_parents_won_avg)}
            만원
          </span>
        </li>
      </ul>
      ...
      <div className="tableWrap">
        <table className="tableTypeA">
          ...
          <tbody>
            {SYdata[1].categoryList.map((YJdata, index) => {
